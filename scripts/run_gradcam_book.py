...
def load_model(timm_id: str, weight_path: Path, strict: bool = True) -> torch.nn.Module:
...
def save_gradcam_comparison(ctrl_model, tc_model, arch: str,
                             ...
                             run_display: str, alpha: float = 0.5):
...
def main():
    ...
    for run in BOOK_RUNS:
        ...
        for arch, timm_id, img_size in ARCHS:
            ...
            ctrl_model = load_model(timm_id, ctrl_pt)
            tc_model   = load_model(timm_id, tc_pt)
